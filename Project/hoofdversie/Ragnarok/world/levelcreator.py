...
#-------------------------------------------------------------------------------                        
    ...
    if levelname == 'level_1.png':  
        ...
        objects.text(4141,1000,(255,255,255), 'Ik en Olaf waren afgescheiden van de rest,')

        objects.text(5711,1104,(255,255,255), 'maar meer herinner ik me niet')
        objects.text(6946,804,(255,255,255), 'Waar ben ik eigenlijk?')
        objects.text(6946,854,(255,255,255), 'Het is zo droevig hier')
        objects.text(7500,800,(255,255,255), 'laat ik het opvrolijken met een kruipanimatie!')
        objects.text(7500,850,(255,255,255), 'Press CTRL')
        objects.text(8929,292,(255,255,255), 'En ik kan ook bijlen gooien')       
        objects.text(8929,342,(255,255,255), 'Press F')
