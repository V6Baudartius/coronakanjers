...
#begin verticale input
    ...
    def collision(self):
        ...
        for each in allCollisionObjects:
            ...
            #als in range dan voeg toe aan de lijst
...
###DEUR MOET HIERAAN TOEGEVOEGD WORDEN
...
#Hier begint de functie drawclock waarin een stopwatch wordt geïnitïeerd en daarna ook getekend/
    def drawstopwatch(self):
        ...
        if self.outline and self.dikte>0 and self.dikte<10:
            ...
            pygame.draw.rect(screen, self.kleuroutline, (self.xleft-5-self.dikte, self.ytop+5-self.dikte, breedte+2*self.dikte, hoogte+2*self.dikte))
        #kleinere rechthoek wordt getekent    
        pygame.draw.rect(screen, self.kleurrect, (self.xleft-5, self.ytop+5, breedte, hoogte))
        ...
        screen.blit(tijd_tekst, (self.xleft,self.ytop))
